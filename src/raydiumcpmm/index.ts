...
import { extender, extender_token } from "./bot";
...
export async function runRaydiumVolumeBot() {
	...
	const asciiArt = figlet.textSync("Raydium CPMM", {
		font: "Standard",
	...
	const coloredAsciiArt = chalk.yellowBright(asciiArt);
